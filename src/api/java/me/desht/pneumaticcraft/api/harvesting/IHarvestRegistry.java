...
public interface IHarvestRegistry {
     ...
     */
    void registerHarvestHandlerCactuslike(Predicate<IBlockState> blockChecker);
     ...
     */
    void registerHarvestHandlerCroplike(Predicate<IBlockState> blockChecker, PropertyInteger ageProperty, Predicate<ItemStack> isSeed);
     ...
     */
    void registerHarvestHandlerTreelike(Predicate<IBlockState> blockChecker, Predicate<ItemStack> isSapling, IBlockState saplingState);
     ...
     */
    void registerHoe(Predicate<ItemStack> isHoeWithDurability, BiConsumer<ItemStack, EntityPlayer> useDurability);
}
