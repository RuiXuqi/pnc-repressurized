...
public interface IHarvestHandler {
     ...
     * @return
     */
    default void harvest(World world, IBlockAccess chunkCache, BlockPos pos, IBlockState state, IDrone drone) {
     ...
     */
    default boolean harvestAndReplant(World world, IBlockAccess chunkCache, BlockPos pos, IBlockState state, IDrone drone) {
     ...
     */
    boolean canHarvest(World world, IBlockAccess chunkCache, BlockPos pos, IBlockState state, IDrone drone);
     ...
     * @param drone
     */
    default void addFilterItems(World world, IBlockAccess chunkCache, BlockPos pos, IBlockState state, NonNullList<ItemStack> stacks, IDrone drone) {
