...
public class NodeProcessorDrone extends FlyingNodeProcessor {
    ...
    protected PathPoint openPoint(int x, int y, int z) {
        return ((EntityDrone) this.entity).isBlockValidPathfindBlock(new BlockPos(x, y, z)) ? super.openPoint(x, y, z) : null;
    }
    ...
    public int findPathOptions(PathPoint[] pathOptions, PathPoint currentPoint, PathPoint targetPoint, float maxDistance) {
        ...
        for (EnumFacing dir : EnumFacing.VALUES) {
            PathPoint point = this.openPoint(currentPoint.x + dir.getXOffset(), currentPoint.y + dir.getYOffset(), currentPoint.z + dir.getZOffset());
