...
public class WidgetTemperature1 extends WidgetBase {

    private int[] scales;
    protected final IHeatExchangerLogic logic;
    private final int minTemp, maxTemp;

    public WidgetTemperature1(int id, int x, int y, int minTemp, int maxTemp, IHeatExchangerLogic logic, int... scales) {
        super(id, x, y, 13, 50);
        this.scales = scales;
        this.logic = logic;
