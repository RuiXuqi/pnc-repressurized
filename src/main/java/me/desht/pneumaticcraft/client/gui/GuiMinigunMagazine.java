...
public class GuiMinigunMagazine extends GuiPneumaticContainerBase implements IExtraGuiHandling {
    ...
    public void initGui() {
        ...
        this.addInfoTab("gui.tooltip.item.minigun");
        this.addAnimatedStat("gui.tab.minigun.slotInfo.title", new ItemStack(Itemss.GUN_AMMO), 0xFF0080C0, true).setText("gui.tab.minigun.slotInfo");
    }
    ...
    public void updateScreen() {
        ...
        if (gunStack.getItem() instanceof ItemMinigun) {
            this.lockedSlot = ItemMinigun.getLockedSlot(gunStack);
        }
    }
    ...
    public void drawExtras(GuiContainerEvent.DrawForeground event) {
        if (this.lockedSlot >= 0) {
            ...
            wr.pos(minX, minY, this.zLevel).endVertex();
            wr.pos(minX, minY + 16, this.zLevel).endVertex();
            wr.pos(minX + 16, minY + 16, this.zLevel).endVertex();
            wr.pos(minX + 16, minY, this.zLevel).endVertex();
