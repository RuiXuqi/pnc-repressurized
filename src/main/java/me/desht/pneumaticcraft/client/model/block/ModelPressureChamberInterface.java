...
public class ModelPressureChamberInterface extends AbstractModelRenderer.BaseModel {
    ...
    public ModelPressureChamberInterface() {
        ...
        this.input = new ModelRenderer(this, 0, 84);
        this.input.addBox(0F, 0F, 0F, 10, 10, 2);
        this.input.setRotationPoint(-5F, 11F, -7.2F);
        this.input.setTextureSize(128, 128);
        this.input.mirror = true;
        this.setRotation(this.input, 0F, 0F, 0F);
        this.output = new ModelRenderer(this, 24, 84);
        this.output.addBox(0F, 0F, 0F, 10, 10, 2);
        this.output.setRotationPoint(-5F, 11F, 5.2F);
    ...
    public void renderModel(float size, TileEntityPressureChamberInterface te, float partialTicks, EntityItem ghostEntityItem) {
        ...
        this.renderDoors(size, renderInputProgress / MAX_PROGRESS, renderOutputProgress / MAX_PROGRESS);
